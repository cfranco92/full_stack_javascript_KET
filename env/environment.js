const environment = {
    ...
    publicRoute: process.env.PUBLIC_ROUTE || './../repository/full_stack_javascript_KET/client/dist/',
    filesRoute: process.env.FILES_ROUTE || 'files',
    angularIndex: './../repository/full_stack_javascript_KET/client/dist/client/index.html'
};
